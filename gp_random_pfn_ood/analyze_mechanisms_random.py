...
def main():
    ...
    results_dir = "/home/psquare_a6000/Desktop/conformal_ood/gp_random_pfn_ood/results/mechanistic_plots"
    json_summary_path = "/home/psquare_a6000/Desktop/conformal_ood/gp_random_pfn_ood/results/mechanistic_summary.json"
    ...
    # Reinitialize the model weights to make it untrained/random
    reinitialize_weights(hook_manager.model)
    ...
    for l in range(num_layers):
        ...
        fig.suptitle(f"Untrained Transformer Encoder Layer {l} Manifold Separation (ID vs. OOD)", fontsize=14, fontweight='bold')
        plt.tight_layout()
    ...
    plt.title("Untrained Supervised ID/OOD Separation vs. Transformer Layer Depth", fontweight='bold')
    ...
    plt.title("Untrained Intrinsic Feature Dimensionality vs. Layer Depth", fontweight='bold')
    plt.xticks(range(num_layers))
    plt.legend()
    plt.tight_layout()
    ...
    plt.title("Untrained Shannon Attention Entropy across Layers", fontweight='bold')
    ...
    plt.title("Untrained Residual Stream Update Magnitude per Layer Transition", fontweight='bold')
    ...
    print(f"\nUntrained model mechanistic interpretability pipeline complete!")
