...
def get_jacobian(model, X, y, Q, t, N=10):
    def predict(y_eval):
...
def main():
    ...
    for s in seeds:
        ...
        res.setdefault('curvature', []).append(float(curv))
    ...
    with open('experiments/tier2_audit/results_tabpfn_5seed.json', 'w') as f:
